...
import org.testng.annotations.Test;
	...
	public class ImageStatus {
		...
		@BeforeTest
		public void beforeStatustModule(){
			System.out.println("Gallery should be loaded - Before Test");
			System.out.println();
		}
		
		@AfterTest
		public void afterStatusModule(){
			System.out.println("Gallery should be unloaded - After Test");
		}
		
		@BeforeClass
		public void beforeClass(){
			System.out.println("Precondition for Image Status");
			System.out.println();
		}
		
		@AfterClass
		public void afterClass(){
			System.out.println("Postcondition for Image Status");
		}
